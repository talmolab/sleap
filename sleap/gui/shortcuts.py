...
class ShortcutDialog(QtWidgets.QDialog):
    ...
    def make_form(self):
        ...
        layout.addWidget(QtWidgets.QLabel("Any changes to keyboard shortcuts will not take effect until you quit and re-open the application."))
...
class Shortcuts:
    ...
    _shortcuts = None
    _names = ("new", "open", "save", "save as", "close",
                "add videos", "next video", "prev video",
                "goto frame", "mark frame", "goto marked",
                "add instance", "delete instance", "delete track",
                "transpose", "select next", "clear selection",
                "goto next labeled", "goto prev labeled", "goto next user",
                "goto next suggestion", "goto prev suggestion",
                "goto next track spawn",
                "show labels", "show edges", "show trails",
                "color predicted", "fit", "learning",
                "export clip", "delete clip", "delete area")
