...
def unet(x_in, num_output_channels, depth=3, convs_per_depth=2, num_filters=16, kernel_size=5, upsampling_layers=True, interp="bilinear"):
    """U-net block.
...
def stacked_unet(x_in, num_output_channels, num_stacks=3, depth=3, convs_per_depth=2, num_filters=16, kernel_size=5, upsampling_layers=True, intermediate_inputs=True, interp="bilinear"):
    """Stacked U-net block.
