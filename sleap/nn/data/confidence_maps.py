...
def make_confmaps(
    ...
    Args:
        ...
        xv: Sampling grid vector for x-coordinates of shape (grid_width,) and dtype
            tf.float32. This can be generated by `make_grid_vectors`.
    ...
    See also: make_grid_vectors, make_multi_confmaps
    """
...
def make_multi_confmaps(
    ...
    Args:
        instances: A tensor of shape (n_instances, n_nodes, 2) and dtype tf.float32
            ...
            coordinates on the image. This must be rank-3 even if a single instance is present.
        xv: Sampling grid vector for x-coordinates of shape (grid_width,) and dtype
            tf.float32. This can be generated by `make_grid_vectors`.
        yv: Sampling grid vector for y-coordinates of shape (grid_height,) and dtype
            tf.float32. This can be generated by `make_grid_vectors`.
    ...
    See also: make_grid_vectors, make_confmaps
    """
