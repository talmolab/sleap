...
def test_pipeline_concatenation():
    A = pipelines.Pipeline.from_blocks(pipelines.InstanceCentroidFinder(center_on_anchor_part=False))
    B = pipelines.Pipeline.from_blocks(pipelines.InstanceCropper(crop_width=16, crop_height=16))
    ...
    D = pipelines.Pipeline.from_blocks(pipelines.InstanceCentroidFinder(center_on_anchor_part=False))
    D += pipelines.Pipeline.from_blocks(pipelines.InstanceCropper(crop_width=16, crop_height=16))
    ...
    E = pipelines.Pipeline.from_blocks(pipelines.InstanceCentroidFinder(center_on_anchor_part=False))
    E |= pipelines.Pipeline.from_blocks(pipelines.InstanceCropper(crop_width=16, crop_height=16))
    ...
    F = pipelines.Pipeline.from_blocks(pipelines.InstanceCentroidFinder(center_on_anchor_part=False))
    ...
    G = pipelines.Pipeline.from_blocks(pipelines.InstanceCentroidFinder(center_on_anchor_part=False))
