...
Any Python installation commands (:`conda install`:code:: or :`pip install`:code::) issued after activating an
...
**sLEAP** has now been installed in the :`sleap_env`:code:: conda environment. With the envirnoment active, enter
