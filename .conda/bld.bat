...
pip install cattrs==1.0.0rc0 opencv-python-headless==4.2.0.34 "PySide2>=5.12.0,<=5.14.1" imgaug==0.3.0 qimage2ndarray==1.8 imgstore==0.2.9 jsmin seaborn scikit-video pykalman==0.9.5
pip install
