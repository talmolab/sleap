...
![Tracker dialog](_static/tracker.jpg)

See [tracking method details](../guides/tracking-methods.md) for more information about the tracker methods and options.
...
![Model selection](_static/model-selection.jpg)
...
![Fixing track](_static/fixing-track.gif)
...
For more tools and tips, see the [proofreading](../guides/proofreading.md) guide.

Once you're done proofreading, you'll want to [export data for analysis](analysis.md).