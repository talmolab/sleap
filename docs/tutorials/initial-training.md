...
> **Note:** This tutorial assumes you have a GPU in your local machine and that TensorFlow is able to use your GPU. If you don't have a GPU or you're having trouble getting it to work, you can run training and inference in the cloud. See our [Colab guide](../guides/colab.md)! Or take a look at our other [guides](../guides/index.md) about running SLEAP on remote machines.
...
![Top-down approach](_static/topdown_approach.jpg)
...
![Bottom-up approach](_static/bottomup_approach.jpg)
...
For more information about the types of models you can train, see [choosing models](../guides/choosing-models.md).
...
Continue to [assisted labeling](assisted-labeling.md).