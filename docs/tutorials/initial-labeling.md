...
![Frame suggestions](_static/suggestions.jpg)

(See [suggestion methods](../guides/suggestion-methods.md) for more information about the suggestion methods.)
...
![Labeling process](_static/labeling.gif)

You can **move the entire instance** by holding down the Alt key (or Option on a Mac) which you then click on a node and drag the instance. You can **rotate the instance** by holding down the Alt key while you then click on a node and use the scroll-wheel.
...
![Toggle visibility](_static/toggle-visibility.gif)
...
Continue to [initial training](initial-training.md).